FROM ruby:2.1
RUN echo mysql-server-10.0 mysql-server/root_password password 'supers3curePaSswd' | debconf-set-selections
RUN echo mysql-server-10.0 mysql-server/root_password_again password 'supers3curePaSswd' | debconf-set-selections
